...
R: O texto diferencia claramente programação, que é o ato imediato de escrever código para resolver problemas pontuais, de engenharia de software, que exige a aplicação de rigor e processos estruturados para garantir a longevidade e confiabilidade de sistemas complexos. Essa distinção é comparável à diferença entre construir uma simples casa na árvore no quintal, onde o improviso é aceitável, e projetar um arranha-céu, que exige cálculos estruturais e normas de segurança rígidas tal qual na engenharia civil ou mecânica. Enquanto um script rápido pode ser escrito individualmente sem grandes consequências em caso de falha, sistemas de longa duração — como softwares bancários ou de infraestrutura crítica — demandam essa disciplina de engenharia ("programação integrada ao longo do tempo"), pois a crescente dependência da sociedade nessas tecnologias torna os erros inaceitáveis e exige que o desenvolvimento de software atinja o mesmo nível de confiança e profissionalismo das engenharias tradicionais.
...
<img width="974" height="601" alt="barbearia" src="https://github.com/user-attachments/assets/d24541ca-566d-470c-9bb6-bfffbd3bd62a" />

-Cliente

<img width="763" height="589" alt="Cliente" src="https://github.com/user-attachments/assets/f6812347-9370-4b0b-8101-2cedbba2040a" />


-Barbeiro

<img width="718" height="526" alt="Barbeiro" src="https://github.com/user-attachments/assets/4faa7785-50d2-4bfe-bcb1-d93d66a83185" />


-Agendamento

<img width="835" height="660" alt="Agendamento" src="https://github.com/user-attachments/assets/23975b6f-63ae-44aa-8527-429c0f1926e6" />

-------------------------------------------------------------------------------------------------------------------------------------------

6. Teste Automatizado

 <img width="984" height="619" alt="Teste Automatizado" src="https://github.com/user-attachments/assets/707ad8f5-a7f0-4ea4-981d-162337259c50" />
